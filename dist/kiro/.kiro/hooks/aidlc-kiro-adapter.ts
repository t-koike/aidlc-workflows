...
// forwarding-loop anchor `bun .kiro/tools/aidlc.ts __delegate orchestrate next <ARGS>`. We read the args
...
function extractNextInvocation(
  ...
  // Match the FIRST `… bun .kiro/tools/aidlc.ts __delegate orchestrate next <ARGS>` occurrence (the loop's
