...
- Invoke `bun .codex/tools/aidlc.ts __delegate worktree` from the main repo checkout; `aidlc-worktree` itself emits the audit event audit-first before invoking git
