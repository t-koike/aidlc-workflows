...
`bun .codex/tools/aidlc.ts __delegate orchestrate report --stage requirements-analysis --result <outcome>`.
...
`bun .codex/tools/aidlc.ts __delegate utility recompose --add user-stories`
