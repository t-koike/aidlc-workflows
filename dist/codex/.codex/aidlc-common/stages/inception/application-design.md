...
`bun .codex/tools/aidlc.ts __delegate orchestrate report --stage application-design --result <outcome>`.
...
`bun .codex/tools/aidlc.ts __delegate utility recompose --add units-generation`
