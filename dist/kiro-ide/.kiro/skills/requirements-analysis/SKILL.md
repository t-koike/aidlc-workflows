...
When applied at other stages (e.g., by a contributor reviewing application-design), this skill manifests as: checking that every design decision traces back to a stated requirement, flagging design elements that have no requirement basis, and identifying requirements that are not addressed by the design.
