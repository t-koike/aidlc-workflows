...
`bun .claude/tools/aidlc.ts __delegate orchestrate report --stage requirements-analysis --result <outcome>`.
...
`bun .claude/tools/aidlc.ts __delegate utility recompose --add user-stories`
