...
2. Log the affirmation question with `bun .claude/tools/aidlc.ts __delegate log decision`.
...
5. Log the exact answer with `bun .claude/tools/aidlc.ts __delegate log answer`.
