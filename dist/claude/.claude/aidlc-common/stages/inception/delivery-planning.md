...
`bun .claude/tools/aidlc.ts __delegate orchestrate report --stage delivery-planning --result <outcome>`.
...
`bun .claude/tools/aidlc.ts __delegate state set-construction-iteration unit-major`.
