...
- Load guardrails from `.aidlc/rules/`
...
- Load `.aidlc/rules/aidlc-team.md` if affirmation already happened (re-run pre-fill from prior affirmed sections)
- Load `.aidlc/rules/aidlc-org.md` for greenfield default suggestions
