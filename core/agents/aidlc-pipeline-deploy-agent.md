...
- Read team practices via `{{HARNESS_DIR}}/rules/aidlc-team.md` (fall back to `org.md` per `knowledge/aidlc-shared/rules-reading.md`); match the affirmed branching strategy to one of the five in `branching-strategies.md`
